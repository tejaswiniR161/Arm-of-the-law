...
<h2 style='margin-left:9cm'> Search For Staff </h2>
<br/>

<form action="staffrecordsearchid.php" method="post">
<table style='margin-left:4cm'>
<tr><th align="center" colspan="2">Search Using ID</th></tr>
...
<form action="staffrecordsearchname.php" method="post">
<table style='margin-left:4cm'>
...
<form action="staffrecordsearchps.php" method="post">
<table style='margin-left:4cm'>
<tr><th align="center" colspan="2">Search Under Police Station</th></tr>
