...
$sn=$_POST['sn'];
            ...
            $sql="SELECT * from accuseddetails where acc_fn='$fn' and acc_sn='$sn'";
            ...
            {
                echo "<script> alert('Note The Aadhar Number And Search Via Aadhar Number To Check The Case ID(s) Involved By The Accused'); </script>";
            $conn->close();
            ...
            $query = "select * from accuseddetails where acc_fn='$fn' and acc_sn='$sn'";
            $result = mysql_query($query);

            echo "<br/> <br/> <br/>";
            echo "<table style='margin-left:3cm'>";

            echo "<tr> <th> Accused ID </th> <th> Aadhar Number </th> <th> Phone Number </th> <th> Name </th> <th> Address </th> <th> Date Of Birth </th> </tr>";

            while($row = mysql_fetch_array($result))
            {   
            echo "<tr><td>" . $row['acc_id'] . "</td><td>"  . $row['acc_aadhar'] . "</td><td>" . $row['acc_ph_no'] . "</td>";  
