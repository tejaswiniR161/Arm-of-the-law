...
$vad=(int)$vad;
            ...
            $sql="SELECT * from victimdetails where vic_aadhar=$vad";
            ...
            $query = "select * from victimdetails where vic_aadhar=$vad";
            $result = mysql_query($query);

            echo "<br/> <br/> <br/>";
            echo "<table style='margin-left:3cm'>";

            echo "<tr> <th> Victim ID </th> <th> Phone Number </th> <th> Name </th> <th> Address </th> <th> Date Of Birth </th> </tr>";

            while($row = mysql_fetch_array($result))
            {  
            $vid=$row['vic_id']; 
            echo "<tr><td>" . $row['vic_id'] . "</td><td>" . $row['vic_ph_no'] . "</td>";  
            ...
            $query = "select * from victimcases where vic_id=$vid";
            $result = mysql_query($query);
